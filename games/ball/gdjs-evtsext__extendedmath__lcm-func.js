...
gdjs.evtsExt__ExtendedMath__Lcm.conditionTrue_0 = {val:false};
gdjs.evtsExt__ExtendedMath__Lcm.condition0IsTrue_0 = {val:false};


gdjs.evtsExt__ExtendedMath__Lcm.userFunc0x98db30 = function(runtimeScene, eventsFunctionContext) {
"use strict";
function gcf(a, b) {
    while (a != b) {
        if (a > b) {
...
gdjs.evtsExt__ExtendedMath__Lcm.userFunc0x98db30(runtimeScene, typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined);

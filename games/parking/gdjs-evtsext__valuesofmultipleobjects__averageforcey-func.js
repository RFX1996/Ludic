...
gdjs.evtsExt__ValuesOfMultipleObjects__AverageForceY.conditionTrue_0 = {val:false};
gdjs.evtsExt__ValuesOfMultipleObjects__AverageForceY.condition0IsTrue_0 = {val:false};
gdjs.evtsExt__ValuesOfMultipleObjects__AverageForceY.condition1IsTrue_0 = {val:false};
...
gdjs.evtsExt__ValuesOfMultipleObjects__AverageForceY.condition0IsTrue_0.val = false;
{
gdjs.evtsExt__ValuesOfMultipleObjects__AverageForceY.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("__ValuesOfObjects").getChild("ObjectsCounted")) == 0;
}if (gdjs.evtsExt__ValuesOfMultipleObjects__AverageForceY.condition0IsTrue_0.val) {
